...
impl<'a, B, O> Future for OrphanAsUnsignaledFuture<'a, B, O>
where
    B: Deref<Target = Oneshot<(), O>>,
    O: TrCmpxchOrderings,
{
...
impl<'a, B, O> Future for OrphanAsCancelledFuture<'a, B, O>
where
    B: Deref<Target = Oneshot<(), O>>,
    O: TrCmpxchOrderings,
{
